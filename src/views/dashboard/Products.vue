...
export default {
  ...
  methods: {
    ...
    getProducts(page = 1) {
      this.isLoading = true;
      const api = `${this.apiPath}${this.uuid}/admin/ec/products?page=${page}`;
    ...
    getDetails(id) {
      this.isLoading = true;
      const api = `${this.apiPath}${this.uuid}/admin/ec/product/${id}`;
      this.$http.get(api).then((res) => {
    ...
    updateProduct() {
      let api = `${this.apiPath}${this.uuid}/admin/ec/product`;
      let httpMethod = 'post';
      if (!this.isNew) {
        api = `${this.apiPath}${this.uuid}/admin/ec/product/${this.tempProduct.id}`;
        httpMethod = 'patch';
      }
    ...
    delProduct() {
      this.isLoading = true;
      const url = `${this.apiPath}${this.uuid}/admin/ec/product/${this.tempProduct.id}`;
    ...
    uploadFile() {
      ...
      const url = `${this.apiPath}${this.uuid}/admin/storage`;
